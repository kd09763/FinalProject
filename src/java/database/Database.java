...
/**
 * Purpose: Grabs information from a database containing statistics
 * about death rates, infection rates, and vaccination rates of the
 * COVID-19 Virus.
 * @author ryant
 */
public class Database {
    ...
    /**
     * Connects to the database and retrieves the COVID-19 death number
     * of each state. Returns the death number of the states as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the COVID-19 deaths, age 18+,
     * of each state. Returns the deaths of the states as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the COVID-19 deaths, age 65+,
     * of each state. Returns the deaths of the states as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the male death number
     * of each state. Returns the deaths of the states as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the female death number
     * of each state. Returns the death of the states as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the amt of COVID-19 cases
     * of each state. Returns the cases of the states as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
     ...
     * of each state. Returns the numbers as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the COVID-19 cases of males
     * of each state. Returns the numbers as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the COVID-19 female deaths
     * of each state. Returns the numbers as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the vaccination number, 18+,
     * of each state. Returns the numbers as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
    ...
    /**
     * Connects to the database and retrieves the vaccination number, 65+,
     * of each state. Returns the numbers as an integer
     * list, organized by state alphabetical order.
     * @return 
     */
